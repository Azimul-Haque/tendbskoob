    ...
    <div class="content container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page"><?php echo e(\App\CPU\translate('Writer/ Translators/ Editors')); ?></li>
            </ol>
        </nav>
        ...
        <div class="row">
            <div class="col-md-7">
                <div class="card">
                    ...
                    <div class="card-body" style="text-align: <?php echo e(Session::get('direction') === "rtl" ? 'right' : 'left'); ?>;">
                        <form action="<?php echo e(route('admin.author.store')); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="row">
                                <div class="col-6">
            ...
            <div class="col-md-5">
                <div class="card">
                    ...
                    <div class="card-body" style="text-align: <?php echo e(Session::get('direction') === "rtl" ? 'right' : 'left'); ?>;">
                        <form action="<?php echo e(route('admin.author.bulkupload')); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                    ...
                    <div class="card-body" style="padding: 0">
                        <div class="table-responsive">
                            <table style="text-align: <?php echo e(Session::get('direction') === "rtl" ? 'right' : 'left'); ?>;"
                                ...
                                <tr>
                                    <th><?php echo e(\App\CPU\translate('Author ID')); ?></th>
                                    <th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-primary btn-sm edit" style="cursor: pointer;"
                                               href="<?php echo e(route('admin.author.edit',[$author['id']])); ?>">
...
<?php echo $__env->make('layouts.back-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\booksbd\resources\views/admin-views/author/index.blade.php ENDPATH**/ ?>