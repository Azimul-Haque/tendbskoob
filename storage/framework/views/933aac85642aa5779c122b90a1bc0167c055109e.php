            ...
            <table class="table">
                ...
                <?php $__currentLoopData = $most_rated_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php if(isset($product)): ?>
                        <tr onclick="location.href='<?php echo e(route('seller.product.view',[$item['product_id']])); ?>'"
...
<!-- End Body -->
<?php /**PATH C:\xampp\htdocs\booksbd\resources\views/seller-views/partials/_most-rated-products.blade.php ENDPATH**/ ?>