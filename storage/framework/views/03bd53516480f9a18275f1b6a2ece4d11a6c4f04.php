    ...
    <div class="content container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page"><?php echo e(\App\CPU\translate('Push Notification Setup')); ?></li>
            </ol>
        </nav>
        ...
        <div class="row gx-2 gx-lg-3">
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <div class="card">
                    <div class="card-header">
                        <h1 class="page-header-title"><?php echo e(\App\CPU\translate('Firebase Push Notification Setup')); ?></h1>
                    </div>
                    <div class="card-body">
                        <form action="<?php echo e(route('admin.business-settings.update-fcm')); ?>" method="post"
                            ...
                            <div class="form-group">
                                <label class="input-label" for="exampleFormControlInput1"><?php echo e(\App\CPU\translate('Server Key')); ?></label>
                            ...
                            <div class="row" style="display: none">
                                ...
                                <div class="col-md-12 col-12">
                                    <div class="form-group">
                                        <label class="input-label" for="exampleFormControlInput1"><?php echo e(\App\CPU\translate('FCM Project ID')); ?></label>
            ...
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                ...
                <div class="card">
                    <div class="card-header">
                        <h2><?php echo e(\App\CPU\translate('Push Messages')); ?></h2>
                    </div>
                    <div class="card-body">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label class="toggle-switch d-flex align-items-center mb-3"
                                            ...
                                            <span class="d-block <?php echo e(Session::get('direction') === "rtl" ? 'mr-2' : ''); ?>"><?php echo e(\App\CPU\translate('Order Pending Message')); ?></span>
                                          </span>
                                        </label>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label class="toggle-switch d-flex align-items-center mb-3"
                                            ...
                                            <span class="toggle-switch-content">
                                                <span class="d-block <?php echo e(Session::get('direction') === "rtl" ? 'mr-2' : ''); ?>"> <?php echo e(\App\CPU\translate('Order Confirmation Message')); ?></span>
                                              </span>
                                        </label>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label class="toggle-switch d-flex align-items-center mb-3"
                                            ...
                                            <span class="toggle-switch-content">
                                                <span class="d-block <?php echo e(Session::get('direction') === "rtl" ? 'mr-2' : ''); ?>"><?php echo e(\App\CPU\translate('Order Processing Message')); ?></span>
                                              </span>
                                        </label>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label class="toggle-switch d-flex align-items-center mb-3"
                                            ...
                                            <span class="toggle-switch-content">
                                                <span class="d-block <?php echo e(Session::get('direction') === "rtl" ? 'mr-2' : ''); ?>"><?php echo e(\App\CPU\translate('Order out for delivery Message')); ?></span>
                                              </span>
                                        </label>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label class="toggle-switch d-flex align-items-center mb-3"
                                            ...
                                            <span class="toggle-switch-content">
                                                <span class="d-block <?php echo e(Session::get('direction') === "rtl" ? 'mr-2' : ''); ?>"><?php echo e(\App\CPU\translate('Order Delivered Message')); ?></span>
                                              </span>
                                        </label>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label class="toggle-switch d-flex align-items-center mb-3"
                                            ...
                                            <span class="toggle-switch-content">
                                                <span class="d-block <?php echo e(Session::get('direction') === "rtl" ? 'mr-2' : ''); ?>"><?php echo e(\App\CPU\translate('Order Returned Message')); ?></span>
                                              </span>
                                        </label>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label class="toggle-switch d-flex align-items-center mb-3"
                                            ...
                                            <span class="toggle-switch-content">
                                                <span class="d-block <?php echo e(Session::get('direction') === "rtl" ? 'mr-2' : ''); ?>"><?php echo e(\App\CPU\translate('Order Failed Message')); ?></span>
                                              </span>
                                        </label>
...
<?php echo $__env->make('layouts.back-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp\www\booksbd\resources\views/admin-views/business-settings/fcm-index.blade.php ENDPATH**/ ?>