                        ...
                        <form class="user mt-4" action="<?php echo e(route('shop.apply')); ?>" method="post" enctype="multipart/form-data" autocomplete="off">
                            ...
                            <div class="form-group row">
                                <div class="col-md-4 mb-3 mb-sm-0">
                                    ...
                                    <input type="text" class="form-control form-control-user" id="name" name="name" value="<?php echo e(old('name')); ?>" placeholder="Din Publications" autocomplete="off" required>
                                </div>
                                <div class="col-md-4">
                                    <label for="address">প্রকাশনীর ঠিকানা</label>
                                    <input type="text" class="form-control form-control-user" id="address" name="address" value="<?php echo e(old('address')); ?>" placeholder="Banglabazar, Dhaka" autocomplete="off" required>
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="form-group row">
                                <div class="col-md-4 mb-3 mb-sm-0">
                                    ...
                                    <input type="email" class="form-control form-control-user" id="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="bdjp@booksbd.net"  autocomplete="off" style="display:none" required>
                                </div>
                                <div class="col-md-4">
...
<?php echo $__env->make('layouts.front-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp\www\booksbd\resources\views/seller-views/auth/register.blade.php ENDPATH**/ ?>