...
<head>
    <meta charset="utf-8">
    <title>
        <?php echo e(\App\CPU\translate('Maintenance Mode on')); ?>
...
<!-- Body-->
<body class="toolbar-enabled rtl" style="text-align: <?php echo e(Session::get('direction') === "rtl" ? 'right' : 'left'); ?>;">

<div class="container rtl" style="text-align: <?php echo e(Session::get('direction') === "rtl" ? 'right' : 'left'); ?>;">
    <div class="row">
        <div class="col-12 mt-5">
            <center>
                <img style="width: 350px!important;" src="<?php echo e(asset('public/assets/front-end')); ?>/img/maintenance-mode.jpg">
                <h1><?php echo e(\App\CPU\translate('Website is under Maintenance')); ?>.</h1><br>
                <h5><?php echo e(\App\CPU\translate('Plese come back later')); ?>.</h5>
            </center>
        </div>
    </div>
</div>
...
<?php /**PATH C:\wamp\www\booksbd\resources\views/web-views/maintenance-mode.blade.php ENDPATH**/ ?>