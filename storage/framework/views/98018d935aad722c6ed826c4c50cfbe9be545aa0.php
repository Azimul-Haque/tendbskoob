...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('public/assets/front-end')); ?>/css/off-canvas-menu.css"/>
...
<!-- Main theme script-->
<script src="<?php echo e(asset('public/assets/front-end')); ?>/js/off-canvas-menu.js"></script>
...
<script>
    ...
    return_value = typeWriter("#globalsearch", text_list, true);
    return_value_m = typeWriter("#globalsearch-m", text_list, true);
</script>
<?php echo $__env->yieldPushContent('script'); ?>

</body>
</html>
<?php /**PATH C:\xampp\htdocs\booksbd\resources\views/layouts/front-end/app.blade.php ENDPATH**/ ?>