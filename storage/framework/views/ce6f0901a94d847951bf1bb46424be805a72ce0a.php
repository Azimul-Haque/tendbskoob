<?php $__env->startSection('title', \App\CPU\translate('Author')); ?>
    ...
    <div class="content container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page"><?php echo e(\App\CPU\translate('Author')); ?></li>
            </ol>
        </nav>
            ...
            <div class="col-md-7">
                <div class="card">
                    ...
                    <div class="card-body" style="text-align: <?php echo e(Session::get('direction') === "rtl" ? 'right' : 'left'); ?>;">
                        <form action="<?php echo e(route('admin.author.update',[$author['id']])); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group"
                                        ...
                                        <label class="input-label"
                                               for="name">Name *</label>
                                        <input type="text" name="name" class="form-control" value="<?php echo e($author->name); ?>" placeholder="Publication Name" required>
                                    </div>
                                ...
                                <div class="col-6">
                                    <div class="form-group"
                                        ...
                                        <input type="text" name="name_bangla" class="form-control" value="<?php echo e($author->name_bangla); ?>" placeholder="Publication Name in Bangla" required>
                                    </div>
                                    <input name="position" value="0" style="display: none">
                                </div>
                                <div class="col-6">
                                    <div class="form-group"
                                        ...
                                        <textarea class="form-control" style="min-height: 150px;" name="description" placeholder="Description"><?php echo e($author->description); ?></textarea>
                                    </div>
                                    <input name="position" value="0" style="display: none">
                                </div>
                                    ...
                                    <div class="form-group">
                                        <center>
                                            <img
                                                ...
                                                src="<?php echo e(asset('public/images/author/' . $author->image)); ?>"
                                                alt="image"/>
                                        </center>
                                    </div>
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        ...
                        data: {id: id},
                        success: function () {
                            toastr.success('<?php echo e(\App\CPU\translate('Author_deleted_Successfully.')); ?>');
                            location.reload();
                        }
                    });
                }
...
<?php echo $__env->make('layouts.back-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp\www\booksbd\resources\views/admin-views/author/edit.blade.php ENDPATH**/ ?>