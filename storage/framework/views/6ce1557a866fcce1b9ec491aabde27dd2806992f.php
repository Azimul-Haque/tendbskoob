                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <?php if(in_array('Pre Order', $category_names) && $product->release_date): ?>
                                    <br/><span style="color: #0300c4 !important;">প্রি-অর্ডারের এ বইটি <b><?php echo e(date('F d, Y', strtotime($product->release_date))); ?></b> তারিখে প্রকাশ পেতে পারে বলে প্রকাশনী থেকে জানানো হয়েছে। তবে বিশেষ কোন কারণে প্রকাশিত হওয়ার তারিখ পরিবর্তিত হতে পারে।</span><br/>
                                <?php endif; ?>
                            </div>
                        </div>
