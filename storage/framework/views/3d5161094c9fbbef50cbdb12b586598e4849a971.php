                ...
                <div class="row align-items-md-center gx-md-5">
                    <div class="col-md-auto mb-3 mb-md-0">
                        <div class="d-flex align-items-center">
                            <img class="avatar avatar-xxl avatar-4by3 <?php echo e(Session::get('direction') === "rtl" ? 'ml-4' : 'mr-4'); ?>"
                            ...
                            <div class="d-block">
                                ...
                                <p> of <?php echo e($product->reviews->count()); ?> <?php echo e(\App\CPU\translate('reviews')); ?>

                                    <span class="badge badge-soft-dark badge-pill <?php echo e(Session::get('direction') === "rtl" ? 'mr-1' : 'ml-1'); ?>"></span>
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md">
                        ...
                        <!-- Review Ratings -->
                            <li class="d-flex align-items-center font-size-sm">
                                ...
                                <span
                                    class="<?php echo e(Session::get('direction') === "rtl" ? 'ml-3' : 'mr-3'); ?>">5 <?php echo e(\App\CPU\translate('star')); ?></span>
                            ...
                            <li class="d-flex align-items-center font-size-sm">
                                ...
                                <span class="<?php echo e(Session::get('direction') === "rtl" ? 'ml-3' : 'mr-3'); ?>">4 <?php echo e(\App\CPU\translate('star')); ?></span>
                                <div class="progress flex-grow-1">
                                    <div class="progress-bar" role="progressbar"
                            ...
                            <li class="d-flex align-items-center font-size-sm">
                                ...
                                <span class="<?php echo e(Session::get('direction') === "rtl" ? 'ml-3' : 'mr-3'); ?>">3 <?php echo e(\App\CPU\translate('star')); ?></span>
                                <div class="progress flex-grow-1">
                                    <div class="progress-bar" role="progressbar"
                                ...
                                <span class="<?php echo e(Session::get('direction') === "rtl" ? 'mr-3' : 'ml-3'); ?>"><?php echo e($three); ?></span>
                            </li>
                            <!-- End Review Ratings -->
                            ...
                            <li class="d-flex align-items-center font-size-sm">
                                ...
                                <span class="<?php echo e(Session::get('direction') === "rtl" ? 'ml-3' : 'mr-3'); ?>">2 <?php echo e(\App\CPU\translate('star')); ?></span>
                                <div class="progress flex-grow-1">
                                    <div class="progress-bar" role="progressbar"
                            ...
                            <li class="d-flex align-items-center font-size-sm">
                                ...
                                <span class="<?php echo e(Session::get('direction') === "rtl" ? 'ml-3' : 'mr-3'); ?>">1 <?php echo e(\App\CPU\translate('star')); ?></span>
                                <div class="progress flex-grow-1">
                                    <div class="progress-bar" role="progressbar"
                    ...
                    <div class="col-4 pt-2">
                        ...
                        <div class="flex-start">
                            ...
                            <span class="mx-1"><?php echo e(\App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($product['unit_price']))); ?></span>
                        </div>
                        <div class="flex-start">
                        ...
                        <div class="flex-start">
                            ...
                            <span class="mx-1"><?php echo e($product->discount_type=='flat'?\App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($product->discount)): $product->discount.''.'%'); ?></span>
                        </div>
                        <div class="flex-start">
...
<?php echo $__env->make('layouts.back-end.app-seller', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\booksbd\resources\views/seller-views/product/view.blade.php ENDPATH**/ ?>