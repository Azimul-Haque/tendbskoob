    ...
    <div class="container pb-5 mb-2 mb-md-4 rtl" style="text-align: <?php echo e(Session::get('direction') === "rtl" ? 'right' : 'left'); ?>;">
        <div class="row">
            <div class="col-md-12 p-3 feature_header">
                <span><?php echo e(\App\CPU\translate('Publication')); ?></span>
            </div>
        </div>
        <div class="row">
            <!-- Content  -->
...
<?php echo $__env->make('layouts.front-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\booksbd\resources\views/web-views/publishers.blade.php ENDPATH**/ ?>