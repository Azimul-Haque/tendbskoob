                ...
                <div class="card">
                    <div class="card-header">
                        <div class="flex-between justify-content-between align-items-center flex-grow-1">
                            <div>
                                <h5><?php echo e(\App\CPU\translate('publication_table')); ?> <span style="color: red;">(<?php echo e($publishers->count()); ?>)</span></h5>
                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-danger btn-sm delete" style="cursor: pointer;"
                                               id="<?php echo e($publisher['id']); ?>" disabled>
...
<?php echo $__env->make('layouts.back-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\booksbd\resources\views/admin-views/publisher/index.blade.php ENDPATH**/ ?>