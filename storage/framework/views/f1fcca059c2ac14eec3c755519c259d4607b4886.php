<?php $__env->startSection('title', \App\CPU\translate('Profile Settings')); ?>
        ...
        <div class="row">
            <div class="col-lg-3">
                ...
                <span class="d-flex justify-content-between align-items-center">
                  <span class="h5 mb-0"><?php echo e(\App\CPU\translate('Nav menu')); ?></span>
                        ...
                        <ul id="navbarSettings"
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="javascript:" id="generalSection" style="color: black">
                                    <i class="tio-user-outlined nav-icon"></i><?php echo e(\App\CPU\translate('Basic')); ?> <?php echo e(\App\CPU\translate('information')); ?>
            ...
            <div class="col-lg-9">
                ...
                <!-- Card -->
                    <div class="card mb-3 mb-lg-5" id="generalDiv">
                        ...
                        <label
                            ...
                            <img id="viewer"
                                 ...
                                 class="avatar-img"
                                 src="<?php echo e(asset('storage/app/public/admin')); ?>/<?php echo e($data->image); ?>"
                                 alt="Image">
                        </label>
                        <!-- End Avatar -->
                    </div>
                    ...
                    <div class="card mb-3 mb-lg-5">
                        <div class="card-header">
                            <h2 class="card-title h4"><?php echo e(\App\CPU\translate('Basic')); ?> <?php echo e(\App\CPU\translate('information')); ?></h2>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row form-group">
                                <label for="firstNameLabel" class="col-sm-3 col-form-label input-label"><?php echo e(\App\CPU\translate('Full')); ?> <?php echo e(\App\CPU\translate('name')); ?>  <i
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-sm-down-break">
                                        <input type="text" class="form-control" name="name" id="firstNameLabel"
                                               placeholder="<?php echo e(\App\CPU\translate('Your first name')); ?>" aria-label="Your first name"
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="email" class="form-control" name="email" id="newEmailLabel"
                                           ...
                                           placeholder="<?php echo e(\App\CPU\translate('Enter new email address')); ?>" aria-label="Enter new email address">
                                </div>
                            </div>
                            <div class="row">
                            <div class="col-md-3 col-form-label">
                                ...
                                <div class="form-group col-md-9" id="select-img">
                                    ...
                                    <div class="custom-file">
                                        ...
                                        <label class="custom-file-label" for="customFileUpload"><?php echo e(\App\CPU\translate('image')); ?> <?php echo e(\App\CPU\translate('Upload')); ?></label>
                                    </div>
                                </div>
                            </div>
                            <div class="d-flex justify-content-end">
                                <button type="button" onclick="<?php echo e(env('APP_MODE')!='demo'?"form_alert('admin-profile-form','Want to update admin info ?')":"call_demo()"); ?>" class="btn btn-primary"><?php echo e(\App\CPU\translate('Save changes')); ?></button>
                            </div>
                            <!-- End Form -->
                        </div>
                        <!-- End Body -->
                ...
                <div id="passwordDiv" class="card mb-3 mb-lg-5">
                    <div class="card-header">
                        <h4 class="card-title"><?php echo e(\App\CPU\translate('Change')); ?> <?php echo e(\App\CPU\translate('your')); ?> <?php echo e(\App\CPU\translate('password')); ?></h4>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <!-- Form Group -->
                            <div class="row form-group">
                                <label for="newPassword" class="col-sm-3 col-form-label input-label"> <?php echo e(\App\CPU\translate('New')); ?>

                                    <?php echo e(\App\CPU\translate('password')); ?></label>

                                <div class="col-sm-9">
                                    <input type="password" class="js-pwstrength form-control" name="password"
                                           id="newPassword" placeholder="<?php echo e(\App\CPU\translate('Enter new password')); ?>"
                            ...
                            <!-- Form Group -->
                            <div class="row form-group">
                                <label for="confirmNewPasswordLabel" class="col-sm-3 col-form-label input-label"> <?php echo e(\App\CPU\translate('Confirm')); ?>
                                ...
                                <div class="col-sm-9">
                                    <div class="mb-3">
                                        <input type="password" class="form-control" name="confirm_password"
                                               id="confirmNewPasswordLabel" placeholder="<?php echo e(\App\CPU\translate('Confirm your new password')); ?>"
                            ...
                            <div class="d-flex justify-content-end">
                                <button type="button" onclick="<?php echo e(env('APP_MODE')!='demo'?"form_alert('changePasswordForm','Want to update admin password ?')":"call_demo()"); ?>" class="btn btn-primary"><?php echo e(\App\CPU\translate('Save')); ?> <?php echo e(\App\CPU\translate('changes')); ?></button>
                            </div>
                        </form>
                        <!-- End Form -->
                    </div>
...
<?php echo $__env->make('layouts.back-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp\www\booksbd\resources\views/admin-views/profile/edit.blade.php ENDPATH**/ ?>