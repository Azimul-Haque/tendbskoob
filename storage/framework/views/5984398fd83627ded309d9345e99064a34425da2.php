                ...
                <form class="mt-3 card p-3" method="post" action="<?php echo e(route('submit-book-request')); ?>" id="open-ticket">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" class="form-control" id="ticket-subject" value="<?php echo e(request()->query("book_name") ? request()->query("book_name") : ''); ?>" name="ticket_subject" placeholder="বইয়ের নাম" required>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            <label for="detaaddressils">বিস্তারিত তথ্য</label>
                            <textarea class="form-control" rows="6" id="ticket-description" name="ticket_description" placeholder="লেখকের নাম&#10;প্রকাশনীর নাম&#10;এবং বই সংক্রান্ত যে কোন তথ্য যা আমাদের বইটি খুঁজে পেতে সহায়তা করবে।" required><?php echo e(request()->query("book_details") ? request()->query("book_details") : ''); ?></textarea>
                        </div>
                    </div>
                    <div class="row">
...
<?php echo $__env->make('layouts.front-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp\www\booksbd\resources\views/web-views/users-profile/book-request.blade.php ENDPATH**/ ?>