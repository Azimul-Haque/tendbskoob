        ...
        <?php $__currentLoopData = $top_sell; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if(isset($item->product)): ?>
                <div class="col-md-4 col-sm-6 mt-2"
                     onclick="location.href='<?php echo e(route('seller.product.view',[$item['product_id']])); ?>'"
                     style="cursor: pointer;padding-right: 6px;padding-left: 6px">
                    <div class="grid-card">
                        <label class="label_1"><?php echo e(\App\CPU\translate('Sold')); ?> : <?php echo e($item['count']); ?></label>
...
<!-- End Body -->
<?php /**PATH C:\xampp\htdocs\booksbd\resources\views/seller-views/partials/_top-selling-products.blade.php ENDPATH**/ ?>