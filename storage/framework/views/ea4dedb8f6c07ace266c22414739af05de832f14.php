        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page"><a
                        href="<?php echo e(route('seller.product.list')); ?>"><?php echo e(\App\CPU\translate('Product')); ?></a>
                </li>
        ...
        <div class="row" style="text-align: <?php echo e(Session::get('direction') === "rtl" ? 'right' : 'left'); ?>;">
            <div class="col-12">
                <div class="jumbotron" style="background: white">
                    ...
                    <p> 4. <?php echo e(\App\CPU\translate('After uploading products you need to edit them and set products images and choices')); ?>.</p>
            ...
            <div class="col-md-12">
                <form class="product-form" action="<?php echo e(route('seller.product.bulk-import')); ?>" method="POST"
...
<?php echo $__env->make('layouts.back-end.app-seller', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\booksbd\resources\views/seller-views/product/bulk-import.blade.php ENDPATH**/ ?>