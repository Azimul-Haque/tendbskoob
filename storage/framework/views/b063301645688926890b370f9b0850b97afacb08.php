                ...
                <div class="navbar-vertical-content mt-2">
                    ...
                    <!--order management ends-->
                        ...
                        <?php if(\App\CPU\Helpers::module_permission_check('product_management')): ?>
                            <li class="nav-item <?php echo e((Request::is('admin/brand*') || Request::is('admin/category*') || Request::is('admin/sub*') || Request::is('admin/attribute*'))?'scroll-here':''); ?>">
                            ...
                            <li class="navbar-vertical-aside-has-menu <?php echo e(Request::is('admin/author*')?'active':''); ?>">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                   href="<?php echo e(route('admin.author.index')); ?>">
...
<?php /**PATH C:\wamp\www\booksbd\resources\views/layouts/back-end/partials/_side-bar.blade.php ENDPATH**/ ?>