                        ...
                        <div class="col-lg-2 col-md-3 col-sm-4 col-6 px-2 pb-4 text-center">
                            <a href="<?php echo e(route('products',['id'=> $author['id'],'data_from'=>'author','page'=>1, 'author_name'=>$author['slug']])); ?>" class="">
                                <div class="brand_div d-flex align-items-center justify-content-center"
                                 style="height: 200px">
                                    <?php if($author->image && file_exists(public_path('public/images/author/' . $author->image))): ?>
                                        <img src="<?php echo e(asset("public/images/author/" . $author->image)); ?>" alt="<?php echo e($author->name); ?>" onerror="this.src='<?php echo e(asset('public/assets/front-end/img/user_demo.jpg')); ?>'" alt="<?php echo e($author->name_bangla); ?>" onmousedown='return false;' onselectstart='return false;' style="height: 135px; width: auto;">
                                    <?php else: ?>
                                        <img src="<?php echo e(asset('public/assets/front-end/img/user_demo.jpg')); ?>" alt="<?php echo e($author->name_bangla); ?>" onmousedown='return false;' onselectstart='return false;' style="height: 135px; width: auto;">
                                    <?php endif; ?>
                                </div>
                            </a>
...
<?php echo $__env->make('layouts.front-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp\www\booksbd\resources\views/web-views/authors.blade.php ENDPATH**/ ?>