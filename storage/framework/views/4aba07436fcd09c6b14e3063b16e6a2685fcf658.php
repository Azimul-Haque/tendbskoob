                            ...
                            <?php if($orderby && $orderby == 'asc'): ?>
                                <?php $__currentLoopData = $pro->sortBy('publisher.name_bangla'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            Active: <?php if($p->status == 1): ?> <span class="badge badge-success">Yes</span> <?php else: ?> <span class="badge badge-warning">No</span> <?php endif; ?><br/>
                                            Featured: <?php if($p->featured == 1): ?> <span class="badge badge-success">Yes</span> <?php else: ?> <span class="badge badge-warning">No</span> <?php endif; ?>
                                        ...
                                        <td>
                                            ...
                                            <?php endif; ?> <br/>
                                            <?php if(in_array('Pre Order', $category_names)): ?>
                                                <small style="color: #0300c4 !important;">Release Date: <?php echo e(date('F d, Y', strtotime($p->release_date))); ?></small><br/><br/>
                                            <?php endif; ?>
