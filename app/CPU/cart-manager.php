    ...
    public static function add_to_cart($request, $from_api = false)
    {
        ...
        if(in_array('Pre Order', $category_names)) {
            ...
            if (isset($check_pre_preorder_cart) == false) {
                ...
                return [
                    'status' => 0,
                    'message' => translate('ইতোমধ্যে একটি প্রি-অর্ডারের বই তালিকায় আছে। একের অধিক প্রি-অর্ডারের পণ্য একসাথে অর্ডার করা সম্ভব হচ্ছে না। আপনি চাইলে প্রি-অর্ডার পণ্যের সাথে স্টকে থাকা অন্য কোন পণ্য যুক্ত করতে পারেন।!')
                ];
            }
        }
        ...
        if ($product->added_by == 'seller') {
            $cart['shop_info'] = Seller::where(['id' => $product->user_id])->first()->name;
        } else {
