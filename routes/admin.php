...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'product', 'as' => 'product.','middleware'=>['module:product_management']], function () {
            ...
            Route::post('approve-status', 'ProductController@approve_status')->name('approve-status');
        ...
        Route::group(['prefix' => 'author', 'as' => 'author.','middleware'=>['module:product_management']], function () {
            ...
            Route::post('delete', 'AuthorController@delete')->name('delete');

            Route::post('bulkupload', 'AuthorController@bulkUpload')->name('bulkupload');
        });

        Route::group(['prefix' => 'publisher', 'as' => 'publisher.','middleware'=>['module:product_management']], function () {
