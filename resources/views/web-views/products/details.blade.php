    ...
    <div class="container mt-4 rtl" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
        ...
        <div class="row" style="direction: ltr; border: 1px solid #e2f0ff; border-radius: 0px; background: white; box-shadow: 1px 1px 6px #00000014;">
            ...
            <div class="col-lg-3 col-md-3" style="background: #F6F6F6;">
                ...
                <div>
                    ১। আলোর উৎস কিংবা ডিভাইসের কারণে বইয়ের প্রকৃত রং কিংবা পরিধি ভিন্ন হতে পারে।<br/>
                    ২। যে কোন সময়, প্রকাশক কর্তৃক বইয়ের কাভার পরিবর্তন হতে পারে। সে ক্ষেত্রে পরিবর্তিত কাভারের বই প্রদান করা হবে।<br/>
                    ৩। ওয়েবসাইটে কাভারের ছবি আপলোড করার সুবিধার্থে আমরা একটি নিদির্ষ্ট সাইজ ব্যবহার করে থাকি। যেকারণে ওয়েবসাইটে দেওয়া কাভারের ছবির সাইজের সাথে প্রকৃত বইয়ের সাইজ ভিন্ন হতে পারে।<br/>
                    ৪। বই অর্ডার করার পূর্বে, অনুগ্রহ পূর্বক আমাদের টার্মস এন্ড কন্ডিশনসগুলো (terms & conditions এর লিংকে হবে লেখাটা) ভালো করে পড়ে নেওয়ার অনুরোধ রইলো।
                </div>
            </div>
        </div>
    </div>
