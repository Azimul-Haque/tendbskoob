        ...
        <div class="row" style="direction: ltr; border: 1px solid #e2f0ff; border-radius: 0px; background: white; box-shadow: 1px 1px 6px #00000014;">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                @if(in_array('Pre Order', $category_names))
                                    ...
                                    <h5 class="mt-3" style="color: green"><img style="margin-right: 8px; width: 18px; height: auto;" src="{{asset('public/assets/front-end/img/in-stock(mini).svg')}}"> {{\App\CPU\translate('Book in')}} <label style="left: 29%!important; top: 29%!important; background-color: #FF9900 !important; color: #FFFFFF !important;" class="badge badge-danger stock-out">Pre Order</label></h5>
                                    {{-- <h5 class="mt-3" style="color: green"><img style="margin-right: 8px; width: 18px; height: auto;" src="{{asset('public/assets/front-end/img/in-stock(mini).svg')}}"> {{\App\CPU\translate('Book in Stock')}}</h5> --}}
                                @endif
                            </div>
                        </div>
            ...
            <div class="col-lg-3 col-md-3" style="background: #F6F6F6;" onmousedown='return false;' onselectstart='return false;'>
                ...
                <div style="font-size: 15px;">
                    ...
                    ৪। বই অর্ডার করার পূর্বে, অনুগ্রহ পূর্বক আমাদের টার্মস এন্ড কন্ডিশনসগুলো (<a href="{{ route('terms') }}" style="color: #5C7CFF !important;">Terms & Conditions</a>) ভালো করে পড়ে নেওয়ার অনুরোধ রইলো।
                </div>
            </div>
        </div>
    </div>
