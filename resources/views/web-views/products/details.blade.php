        ...
        <div class="row" style="direction: ltr; border: 1px solid #e2f0ff; border-radius: 0px; background: white; box-shadow: 1px 1px 6px #00000014;">
            ...
            <div class="col-lg-3 col-md-3" style="background: #F6F6F6;">
                ...
                <div style="font-size: 15px;">
                    ...
                    ৪। বই অর্ডার করার পূর্বে, অনুগ্রহ পূর্বক আমাদের টার্মস এন্ড কন্ডিশনসগুলো (<a href="{{ route('terms') }}" style="color: #5C7CFF !important;">Terms & Conditions</a> এর লিংকে হবে লেখাটা) ভালো করে পড়ে নেওয়ার অনুরোধ রইলো।
                </div>
            </div>
        </div>
    </div>
